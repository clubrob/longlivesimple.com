  ...
  <footer class="footer">
    ...
    <div class="columns">
      <div class="column">
        <div class="content">
          <p>
            &copy; Long Live Simple, LLC {{ currentYear }}
      ...
      <div class="column">
        <div class="content">
          <p class="is-size-5 has-text-right-desktop">Socialize with us:</p>
        </div>
    ...
    <ul>
      ...
      <li>
        <img
          src="/img/icons/mountain-biz-works.png"
          class="image is-64x64"
          alt="Go Local Here 2019"
        >
      </li>
    </ul>
  </footer>
